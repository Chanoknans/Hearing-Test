...
import 'package:flutter_project/Page/PageRight.dart';
import 'dart:async';
import 'dart:io';
...
class _ManualPageState extends State<ManualPageL> {
  ...
  void initState() {
    ...
    audioPlayer.open(
      Playlist(audios: [
        Audio('assets/sound/left1.mp3'),
        Audio('assets/sound/left2.mp3'),
        Audio('assets/sound/left3.mp3'),
        Audio('assets/sound/left4.mp3'),
        Audio('assets/sound/left5.mp3'),
        Audio('assets/sound/left6.mp3'),
        Audio('assets/sound/left1.mp3'),
        Audio('assets/sound/left1.mp3'),
      ]),
      autoStart: false,
  ...
  void getdata() async {
    ...
    setState(() {
      meen = List.from(userDoc.get('today'));
    });
  }
        ...
        leading: GestureDetector(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) {
              return ManualPageR(result1: widget.resultR);
            }));
          },
          child: Icon(
