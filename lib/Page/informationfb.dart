...
import 'package:flutter_project/data/Route.dart';
import 'package:form_field_validator/form_field_validator.dart';
import 'package:image_picker/image_picker.dart';

import '../Myconstant.dart';

class informationfb extends StatefulWidget {
  const informationfb({Key? key}) : super(key: key);

  @override
  _informationfbState createState() => _informationfbState();
}

class _informationfbState extends State<informationfb> {
